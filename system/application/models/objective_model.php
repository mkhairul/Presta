<?php
class Objective_model extends Model {
    
    function Objective_model()
    {
        parent::Model();
        $this->table_name = 'objective';
    ...
    function get_list_perspective($perspective_id=0, $user_id=0)
    {
        if($perspective_id)
        {
    ...
    function get_list($strategic_id=0)
    {
        if($strategic_id)
        {
    ...
    function get_strategic_id($objective_id)
    {
