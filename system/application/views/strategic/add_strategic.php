...
<body>
	<div id="header"></div>
        <div id="content">
            <?php echo form_open('strategic/add_submit'); ?>
            <fieldset>
                <legend>Insert Strategic Themes</legend>
                ...
                <p>
                    ...
                    <br/>
                    <span><?php echo $perspective_name; ?></span>
                    <input type="hidden" name="perspective_id" value="<?php echo $perspective_id; ?>" />
                </p>
                
                <p>
                    <label for="strategic">Strategic Theme</label>
                    <br/>
                    <input id="strategic" class="title" type="text" value="" name="name"/>
                    <br/>
                    <span class="moreinfo">(i.e. Productivity, Revenue Growth, etc)</span>
                </p>
                ...
                <div class="buttons">
                    ...
                    <a href="<?php echo site_url('perspective'); ?>">
            ...
            <?php if(getstr($strategic_list)) { ?>
                <h2>Strategic List</h2>
                <table border="1" cellspacing="0" cellpadding="0">
                    ...
                    <?php
                    foreach($strategic_list->result() as $row)
                    {
                    ?>
                        <tr>
                            <td><?php echo $row->name; ?></td>
                            <td>
                                <a href="<?php echo site_url('objective/index/' . $row->id); ?>">
                                    Add Objectives
                                </a>
                            </td>
                        </tr>
