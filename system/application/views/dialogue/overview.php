...
<body>
	...
	<div id="header"></div>
        <div id="content">
            ...
            <h3><strong>Supervisor:</strong> <?php echo getstr($supervisor_name); ?></h3>
            
            <div class="content-box">
                <h3>1<sup>st</sup> Quarter</h3>
                <div class="contents">
                    <?php if(getstr($dialogue_details->first_quarter)){ ?>
                        <?php echo $dialogue_details->first_quarter; ?>
                    <?php }else{ ?>
                        No comments.
                    <?php } ?>
                </div>
            ...
            <div class="content-box">
                ...
                <div class="contents">
                    <?php if(getstr($dialogue_details->second_quarter)){ ?>
                        <?php echo $dialogue_details->second_quarter; ?>
                    <?php }else{ ?>
                        No comments.
                    <?php } ?>
                </div>
            ...
            <div class="content-box">
                ...
                <div class="contents">
                    <?php if(getstr($dialogue_details->third_quarter)){ ?>
                        <?php echo $dialogue_details->third_quarter; ?>
                    <?php }else{ ?>
                        No comments.
                    <?php } ?>
                </div>
            ...
            <div class="content-box">
                <div class="span-14">
                    ...
                    <div class="contents">
                        <?php if(getstr($dialogue_details->final_review)){ ?>
                            <?php echo $dialogue_details->final_review; ?>
                        <?php }else{ ?>
                            No comments.
                        <?php } ?>
                    </div>
                    <?php
                        if(getstr($dialogue_details->final_rating))
                        {
                            switch((int)$dialogue_details->final_rating)
                            {
                                case 1:
                                    $rating = '1 - Poor';
                                    break;
                    ...
                    ?>
                    <div id="rating">
                        <strong>Rating:</strong> <span><?php echo $rating; ?></span>
                    </div>
                    <?php } ?>
                </div>
